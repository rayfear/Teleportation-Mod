...
public class TeleportationConfig
{
    ...
    public static int tpSaplingID;
	public static int enderMeatID;
    ...
    public static void loadConfig(Configuration config)
    {
        ...
        tpSaplingID = config.getTerrainBlock(Configuration.CATEGORY_BLOCK,
                                             "tpSaplingID", 3646, "tpSaplingID").getInt();
        //Items
        ...
        enderMeatID = config.get(Configuration.CATEGORY_ITEM,
                "Ender Meat", 5013).getInt();
        //General
