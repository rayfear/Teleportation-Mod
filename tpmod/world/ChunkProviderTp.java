...
public class ChunkProviderTp implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    public ChunkProviderTp(World par1World, long par2, boolean par4)
    {
                    ...
                    for (int var31 = 0; var31 < 8; ++var31)
                    {
                        ...
                        for (int var42 = 0; var42 < 4; ++var42)
                        {
                            ...
                            for (int var51 = 0; var51 < 4; ++var51)
                            {
                                if ((var47 += var49) > 0.0D)
                                {
                                    par3ArrayOfByte[var43 += var44] = (byte)Block.cobblestoneMossy.blockID;
                                }
                                else if (var12 * 8 + var31 < var6)
                                {
                                    par3ArrayOfByte[var43 += var44] = (byte)TeleportationBlocks.TeleportingGrass.blockID;
                                }
                                else
                                {
                    ...
                    else
                    {
                        ...
                        else if (var18 == Block.cobblestoneMossy.blockID)
                        {
                            if (var13 == -1)
                            {
                                ...
                                {
                                    var14 = 0;
                                    var15 = (byte)Block.cobblestoneMossy.blockID;
                                }
                                ...
                                if (var16 < var5 && var14 == 0)
                                {
                                    if (var11 < 0.15F)
                                    {
                                        var14 = (byte)TeleportationBlocks.TeleportingGrass.blockID;
                                    }
                                    else
                                    {
                                        var14 = (byte)TeleportationBlocks.TeleportingGrass.blockID;
                            ...
                            else if (var13 > 0)
                            {
                                ...
                                if (var13 == 0 && var15 == TeleportationBlocks.TeleportingGrass.blockID)
                                {
                                    var13 = this.rand.nextInt(4);
                                    var15 = (byte)TeleportationBlocks.TeleportingDirt.blockID;
                                }
                            }
                        }
                    }
