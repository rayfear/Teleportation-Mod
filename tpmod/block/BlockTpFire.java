...
public class BlockTpFire extends BlockFire
{
    ...
    protected BlockTpFire(int par1)
    {
        super(par1);
    ...
    public void onEntityCollidedWithBlock(World par1World, int par2, int par3, int par4, Entity par5Entity)
    {
        ...
        {
            EntityPlayer eLiving = (EntityPlayer) par5Entity;
            eLiving.addPotionEffect(new PotionEffect(9, 400, 25, false));
        }
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        {
            par1World.playSound((double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), "portal.portal", 1.0F + par5Random.nextFloat(), par5Random.nextFloat() * 0.7F + 0.3F, false);
        }
        ...
        if (!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4) && !this.canBlockCatchFire(par1World, par2, par3 - 1, par4, UP))
        {
            if (this.canBlockCatchFire(par1World, par2 - 1, par3, par4, EAST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (this.canBlockCatchFire(par1World, par2 + 1, par3, par4, WEST))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (this.canBlockCatchFire(par1World, par2, par3, par4 - 1, SOUTH))
            {
                for (l = 0; l < 2; ++l)
                {
            ...
            if (this.canBlockCatchFire(par1World, par2, par3, par4 + 1, NORTH))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)par2 + par5Random.nextFloat();
            ...
            if (this.canBlockCatchFire(par1World, par2, par3 + 1, par4, DOWN))
            {
                for (l = 0; l < 2; ++l)
                {
                    f = (float)par2 + par5Random.nextFloat();
