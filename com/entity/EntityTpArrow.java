...
public class EntityTpArrow extends Entity 
{
	...
	public EntityTpArrow(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
	 ...
	 public void onUpdate()
	 {
		 ...
		 else
		 {
			 ...
			 if (entity != null)
			 {
				 ...
				 movingobjectposition.entityHit.setPosition(ItemTeleportationBow.x, ItemTeleportationBow.y, ItemTeleportationBow.z);
